  ...
  return (
    <div className="border border-border rounded-md bg-card">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <h3 className="text-xs font-medium text-foreground">ETH Products</h3>
        {hasSelectedItems && (
          <button
            onClick={handleReset}
      ...
      <div className="px-3 py-2 border-b border-border flex items-center gap-4">
        <div className="text-xs text-muted-foreground">
          Total: <span className="font-medium text-foreground">{formatUsd(totalEthUsd)}</span>
        </div>
                      ...
                      <button
                        ...
                        className={`text-[10px] px-2 py-1 rounded border transition-colors ${
                          leverage?.enabled
                            ...
                            : 'border-border text-muted-foreground hover:text-foreground hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed'
                        }`}
                      >
                        {leverage?.enabled
                          ? `${leverage.ltv}% LTV`
